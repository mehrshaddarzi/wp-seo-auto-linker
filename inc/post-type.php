...
class SEO_Auto_Linker_Post_Type extends SEO_Auto_Linker_Base
{
    ...
    public static function register()
    {
        $labels = array(
            ...
            'menu_name'          => __('Auto Linker', 'seoal')
        );
    ...
    public static function submit_cb($post)
    {
        ...
        </div><p id="major-publishing-action">
    ...
    public static function keyword_cb($post)
    {
        ...
        <table class="form-table">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="widefat <?php if (is_rtl()) {
                        echo 'sal-ltr sal-text-left';
                    } ?>" name="<?php self::key('url'); ?>" id="<?php self::key('url'); ?>" value="<?php self::meta('url'); ?>"/>
                    <p class="description">
            ...
            <tr>
                ...
                <td>
                    <input type="text" class="widefat <?php if (is_rtl()) {
                        echo 'sal-ltr sal-text-left';
                    } ?>" name="<?php self::key('times'); ?>" id="<?php self::key('times'); ?>" value="<?php self::meta('times'); ?>"/>
                    <p class="description">
                        <?php
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="<?php self::key('self_links'); ?>" id="<?php self::key('target'); ?>" value="on"
            ...
            <tr>
                ...
                <td>
                    <input type="checkbox" name="<?php self::key('nofollow'); ?>" id="<?php self::key('nofollow'); ?>" value="on"
    ...
    public static function blacklist_cb($post)
    {
        ...
        $blacklist = implode("\n", $blacklist);
        ?>
        <textarea class="widefat <?php if (is_rtl()) {
            echo 'sal-ltr sal-text-left';
        } ?>" id="<?php self::key('blacklist'); ?>" name="<?php self::key('blacklist'); ?>" rows="15"><?php echo $blacklist; ?></textarea><p class="description">
        <?php _e("URLs on which you don't want to have this link. One URL per line.", 'seoal'); ?>
    </p>
        <?php
    }
