...
class SEO_Auto_Linker_Admin extends SEO_Auto_Linker_Base
{
    ...
    {
        // Settings
        add_action('admin_init', array(get_class(), 'settings'));

        // Menu Page
        add_action('admin_menu', array(get_class(), 'menu_page'));

        // Add Custom Admin Css
        add_action('admin_footer', array(get_class(), 'custom_css'));
    }
    ...
    {
        include SEOAL_PATH . 'inc/admin-asset.php';
    }
    ...
    public static function menu_page()
    {
        ...
        add_submenu_page(
            ...
            __('Import/Export', 'seoal'),
            __('Import/Export', 'seoal'),
            'manage_options',
            'seo-auto-linker-json',
            array(get_class(), 'menu_page_json')
        );
    ...
    public static function cleaner($in)
    {
        ...
        if ( ! is_array($blacklist)) {
            ...
            $out['blacklist'] = array_map('esc_url', array_filter($lines));
        } else {
    ...
    /*
     * Menu page callback.  Handles outputing our Json page
     */
    public static function menu_page_json()
    {
        include SEOAL_PATH . 'inc/admin-json.php';
    }
    ...
    public static function menu_page_cb()
    {
        ?>
        <div class="wrap">
            <h1 class="wp-heading-inline"><?php _e('SEO Auto Linker Options', 'seoal'); ?></h1>
            ...
            <form method="post" action="<?php echo esc_url(admin_url('options.php')); ?>" style="width:80%">
                ...
                submit_button(__('Save Settings', 'seoal'));
                ?>
            </form>
        </div>
        <?php
